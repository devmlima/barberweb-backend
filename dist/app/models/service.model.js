...
var Service = (_dec = (0, _sequelizeTypescript.Table)({
  tableName: "services",
  timestamps: false,
  schema: "public",
  ...
  (0, _inherits2.default)(Service, _BaseModel);
  ...
  function Service() {
    ...
    (0, _initializerDefineProperty2.default)((0, _assertThisInitialized2.default)(_this), "descricao", _descriptor3, (0, _assertThisInitialized2.default)(_this));
  ...
  writable: true,
  initializer: null
}), _descriptor3 = (0, _applyDecoratedDescriptor2.default)(_class2.prototype, "descricao", [_dec5], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
