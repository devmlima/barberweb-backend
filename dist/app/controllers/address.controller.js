...
var _address = require("../models/address.model");
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.prev = 1;
                _context.next = 4;
                return _address.Address.findAll();

              case 4:
                address = _context.sent;
                return _context.abrupt("return", response.status(200).json(address));
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                _context2.prev = 1;
                _context2.next = 4;
                return _address.Address.findOne({
                  where: {
                    id
                  }
                });
              ...
              case 4:
                ...
                return _context2.abrupt("return", response.status(200).json(address));
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                ...
                _context3.prev = 1;
                _context3.next = 4;
                return _address.Address.update(body, {
                  where: {
                    id: body.id
                  }
                });
          ...
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                ...
                _context5.next = 5;
                return _address.Address.create(params);
